...
void QGCPalette::_buildMap(void)
{
    ...
    DECLARE_QGC_COLOR(alertBackground,      "#fce94f", "#fce94f", "#fce94f", "#fce94f")
    ...
    DECLARE_QGC_COLOR(brandingPurple,       "#204a87", "#204a87", "#204a87", "#204a87")
    DECLARE_QGC_COLOR(brandingBlue,         "#204a87", "#204a87", "#204a87", "#204a87")
}
