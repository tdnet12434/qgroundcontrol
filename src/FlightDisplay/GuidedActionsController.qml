...
Item {
    ...
    readonly property string emergencyStopTitle:            qsTr("หยุดฉุกเฉิน")
    readonly property string armTitle:                      qsTr("เปิดใบพัด/เซอร์โว")
    readonly property string disarmTitle:                   qsTr("ปิดใบพัด/เซอร์โว")
    readonly property string rtlTitle:                      qsTr("บินกลับ")
    readonly property string takeoffTitle:                  qsTr("ขึ้นบิน")
    readonly property string landTitle:                     qsTr("ลงจอด")
    readonly property string startMissionTitle:             qsTr("เริ่มภารกิจ")
    readonly property string continueMissionTitle:          qsTr("กลับไปยังภารกิจ")
    readonly property string resumeMissionTitle:            qsTr("ทำภารกิจต่อ")
    readonly property string resumeMissionUploadFailTitle:  qsTr("การทำภารกิจต่อล้มเหลว")
    readonly property string pauseTitle:                    qsTr("หยุด")
    readonly property string changeAltTitle:                qsTr("เปลี่ยนความสูง")
    readonly property string orbitTitle:                    qsTr("Orbit")
    readonly property string landAbortTitle:                qsTr("ยกเลิกการลงจอด")
    readonly property string setWaypointTitle:              qsTr("ตั้งตำแหน่งการบิน")
    readonly property string gotoTitle:                     qsTr("ไปวนที่ตำแหน่ง")

    readonly property string armMessage:                        qsTr("เปิดการทำงานใบพัด(Arm)")
    readonly property string disarmMessage:                     qsTr("ปิดการทำงานใบพัด(Disarm)")
    ...
    readonly property string takeoffMessage:                    qsTr("ขึ้นบินและบินวนบริเวณขึ้นบิน")
    readonly property string startMissionMessage:               qsTr("ขึ้นบินและเริ่มภารกิจ")
    readonly property string continueMissionMessage:            qsTr("ทำภารกิจต่อจากก่อนหน้า้")
    ...
    readonly property string landMessage:                       qsTr("ลงจอดในตำแหน่งปัจจุบัน")
    readonly property string rtlMessage:                        qsTr("บินกลับตำแหน่งที่ใช้ขึ้นบิน")
    readonly property string changeAltMessage:                  qsTr("Change the altitude of the vehicle up or down.")
    readonly property string gotoMessage:                       qsTr("บินไปยังเป้าหมายและวนเป็นวงกลมบริเวณนั้น")
             property string setWaypointMessage:                qsTr("Adjust current waypoint to %1.").arg(_actionData)
    readonly property string orbitMessage:                      qsTr("Orbit the vehicle around the current location.")
    readonly property string landAbortMessage:                  qsTr("ยกเลิกกระบวนการลงจอด")
